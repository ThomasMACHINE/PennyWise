...
I think the work went great, Ideally I would have liked to do some more polishing to our development process. It would have been cool to formulate tickets as stories and work with Story Driven Development. Requirements on tickets would also have been an improvement as that would force the group to align on the criterias the work should meet. However, there was little problems when it came to this as most tickets were resolved well and with high quality.
